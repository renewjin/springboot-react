...
// @RequestMapping애 /수질오염서비스api 를 작성해주면 됨 @RequestMapping("/수질오염서비스로이동하기")
@RestController
public class APISController {
	// 3번 
	@GetMapping("/getCtprvnRltmMesureDnsty") //시도별 실시간 측정 정보 조회 api주소
	public String get실시간측정정보() {
		return "측정결과전달하기";
	}
	
	// 1번과 2번 return 측정 결과 전달하기
	// 4번과 5번 void system.out.pringln(측정 결과 전달하기)
	...
	//2. GetMapping 주소로 통합대기환경지수 나쁨이상 측정소 목록조회
