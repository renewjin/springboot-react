 ...
 * @RequestMapping("/api") 주석을 풀어서 모든 url 앞애 api가 붙도록 설정
 * */
@RequestMapping("/api")
public class NaverLoginController {
	 ...
	 * */
	// application.properties naver.client-id = fpsgvV70MG_CnzoGIh6r
	@Value("${naver.client-id}")
	private String clientId; // clientId = fpsgvV70MG_CnzoGIh6r
	
	//application.properties naver.client-secret=DIaUDMrBxK
	@Value("${naver.client-secret}")
	private String clientSecret; // clientSecret = DIaUDMrBxK
